...
export const people: Person[] = [
  ...
  { id: "solhee-hong", name: "Solhee Hong", role: "Researcher", focus: "Veterinary informatics, SNOMED CT, LLMs, and Python", projects: ["Standardization of Clinical Terminology in Veterinary Medicine", "Telepet"], bio: "Standardizes veterinary clinical data with manual and LLM-assisted SNOMED CT mapping and contributes to multimodal companion-animal AI.", image: "/people/Solhee_Hong.jpg" },
  { id: "angela-do-youn-kim", name: "Angela Do Youn Kim", role: "Student", focus: "Bioinformatics, LLMs, SNOMED CT, and AI agents", projects: ["Telepet", "Standardization of Clinical Terminology in Veterinary Medicine"], bio: "Develops multimodal AI for companion-animal emotion prediction and veterinary clinical terminology systems based on SNOMED CT.", image: "/people/Angeladoyoun_Kim.jpg" },
];
